      ...
      {isAuth ? (
        ...
        {alert && <Alert 
          ...
          <div className="container content pt-3">
            ...
            >
              {isEdit ? "Edit Your Recipe!" : "Create Your New Recipe!"}
            </h1>
            ...
            <div className="container mx-auto">
              <div className="main-form row m-0 p-3 mt-3">
                ...
                <div className="form-section my-2 p-3 px-lg-5">
                  {/* <!-- Ingredients Header --> */}
                  <div className="form-header align-content-center mb-3">
                    <span className="fs-5 text-uppercase ">Ingredients</span>
                    <IconButton
                      variant="outlined"
                      className="px-3 py-2 btn btn-sm text-muted circle-btn button-add-remove"
                      ...
                      <div className="row" key={"Ingredient " + index + 1}>
                        <div className="col-8">
                          ...
                          >
                            ...
                            {/* <TextField
                              ...
                              onChange={(event) => {
                                const newIngredients = [...ingredients];
                                newIngredients[index].ingredients_name =
                                  event.target.value;
                                updateIngredient(newIngredients);
                        ...
                        <div className="col-1">
                          <IconButton
                            ...
                            variant="outlined"
                            className="px-3 py-2 btn btn-sm text-muted button-add-remove"
                            onClick={(event) => {
                    ...
                    {instructions.map((instruction, index) => (
                      <div className="row" key={"Instruction " + (index + 1)}>
                        <div className="row p-0 m-0">
                          ...
                          <div className="col-2 button-image-div">
                            <span>
                              <input
                                multiple
                                type="file"
                                ...
                                style={{ paddingTop: "4px", marginTop: "15px" }}
                                // className="px-1 py-20 btn btn-sm text-muted circle-btn button-add-remove button-image"
                                onChange={(event) => {
                                  const imageArray = [];
                                  const newInstructions = [...instructions];
                              ...
                              (<span style={{
                                fontSize: "13px",
                              }}> {instructions[index].images.length + " file(s)"}</span>)
                              }
                            </span>
                          </div>
                          <div className="col-1">
                ...
                <div className="form-section my-2 p-3 px-lg-5">
                  ...
                  <input
                    ...
                    className="btn btn-outline-secondary btn-lg btn-block pb-3"
                    onChange={(event) => {
                      const imageArray = [];
                      [...event.target.files].forEach((file) => {
                        imageArray.push(file);
